...
from tensor2tensor.layers import common_layers_switchable
...
class Transformer(t2t_model.T2TModel):
  ...
  def encode(self, inputs, target_space, hparams, features=None, losses=None):
    ...
    """
    inputs = common_layers_switchable.flatten4d3d(inputs)
    ...
    encoder_output = transformer_encoder(
        ...
        make_image_summary=not common_layers_switchable.is_xla_compiled(),
        losses=losses,
  ...
  def decode(self,
    ...
    if (common_layers_switchable.is_xla_compiled() and
  ...
  def body(self, features):
    ...
    targets_shape = common_layers_switchable.shape_list(targets)
    targets = common_layers_switchable.flatten4d3d(targets)
  ...
  def _fast_decode_tpu(self,
    ...
    if self.has_input:
      ...
      if target_modality.is_class_modality:
        ...
        decode_length = (
            common_layers_switchable.shape_list(inputs)[1] + features.get(
      ...
      s = common_layers_switchable.shape_list(inputs)
      batch_size = s[0]
      ...
      partial_targets = common_layers_switchable.expand_squeeze_to_nd(partial_targets, 2)
      partial_targets = tf.to_int64(partial_targets)
      partial_targets_shape = common_layers_switchable.shape_list(partial_targets)
...
def fast_decode_tpu(encoder_output,
  ...
  if encoder_output is not None:
    batch_size = common_layers_switchable.shape_list(encoder_output)[0]
  ...
  if beam_size > 1:  # Beam Search
    ...
    def inner_loop(i, hit_eos, next_id, decoded_ids, cache, log_prob):
      ...
      log_probs = common_layers_switchable.log_prob_from_logits(logits)
      temperature = getattr(hparams, "sampling_temp", 0.0)
      if hparams.sampling_method == "argmax":
        temperature = 0.0
      next_id = common_layers_switchable.sample_with_temperature(logits, temperature)
...
class TransformerScorer(Transformer):
  ...
  def infer(self,
    ...
    log_probs = common_layers_switchable.index_last_dim_with_indices(log_probs, targets)
...
def transformer_prepare_decoder(targets, hparams, features=None):
    ...
    if hparams.prepend_mode == "prepend_inputs_full_attention":
      ...
      decoder_self_attention_bias = (
          common_attention.attention_bias_lower_triangle(
              common_layers_switchable.shape_list(targets)[1]))
  else:
    # Full attention.
  ...
  if hparams.proximity_bias:
    decoder_self_attention_bias += common_attention.attention_bias_proximal(
        common_layers_switchable.shape_list(targets)[1])
  decoder_input = common_layers_switchable.shift_right_3d(targets)
  if hparams.pos == "timing":
...
def transformer_decoder(decoder_input,
  ...
  attention_dropout_broadcast_dims = (
      common_layers_switchable.comma_separated_string_to_integer_list(
  ...
  with tf.variable_scope(name):
      ...
      with tf.variable_scope(layer_name):
        with tf.variable_scope("self_attention"):
          y = common_attention.multihead_attention(
              common_layers_switchable.layer_preprocess(x, hparams),
              None,
              decoder_self_attention_bias,
          ...
          x = common_layers_switchable.layer_postprocess(x, y, hparams)
        if encoder_output is not None:
    ...
    mlperf_log.transformer_print(
        ...
        hparams=hparams)
    return common_layers_switchable.layer_preprocess(x, hparams)
