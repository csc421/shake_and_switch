...
flags.DEFINE_bool("weight_lower_bound", False,
                  "This parameter indicates if lower bound should be used")
...
def save_metadata(hparams):
  ...
  if not tf.gfile.Exists(output_dir):
    ...
    print("The log dir already exists.")
    exit()
  FLAGS.output_dir = output_dir
  print("The log file is {}".format(FLAGS.output_dir))
